...
public abstract class NArrayListAdapter<T> extends BaseAdapter {
     ...
     * @param position
     */
    public abstract void initView(BaseViewHolder viewHolder, View convertView, int position);
     ...
     * @param position
     */
    public abstract void setData(BaseViewHolder viewHolder, View convertView, int position);
     ...
     * @return
     */
    @SuppressWarnings({"hiding", "RestrictedApi"})
