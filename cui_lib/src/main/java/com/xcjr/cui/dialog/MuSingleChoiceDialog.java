...
public class MuSingleChoiceDialog extends DialogFragment implements OnClickListener {
    ...
    public interface MuSingleSelectedDialogCallback {
         ...
         */
        public void listItemClick(String selectedData, String dataCode, int position);
    }
     ...
     */
    public static MuSingleChoiceDialog show(FragmentActivity act, String titleStr,
                                            int listDataResId, List<String> listData,
                                            List<String> listDataCode, MuSingleSelectedDialogCallback mCallback) {
        mTitleStr = titleStr;
        if (listDataResId != 0) {
    ...
    public class MyAdapter extends NArrayAdapter {
        ...
        public View getListItemView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                // 初始化空间
                viewHolder.itemDataTv = (TextView) convertView.findViewById(R.id.itemDataTv);
